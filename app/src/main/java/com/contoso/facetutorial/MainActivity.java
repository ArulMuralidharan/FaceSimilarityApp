...
public class MainActivity extends Activity {
    ...
    private final String subscriptionKey = "875c7b40316b4ebd92b34734b369e821";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.e("Tag", allFaces.size() + "");
                findSimilarFaces();
            }
        });

        Button selectFace = findViewById(R.id.button);
        selectFace.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (allSimilarFaces != null) {
                    for (SimilarFace face : allSimilarFaces) {
                        if (face != null) {
                            Log.e("TAG", face.confidence + "");
                            Log.e("TAG", face.faceId+ "");
                        }
                    }
                }
            }
                ...
                new AsyncTask<InputStream, String, SimilarFace[]>() {
                    ...
                    protected SimilarFace[] doInBackground(InputStream... params) {
                        try {
                            ...
                            SimilarFace[] result = faceServiceClient.findSimilar(allUUID.get(0), Arrays.copyOfRange(allUUID.toArray(), 1, allUUID.size(), UUID[].class), 1, FaceServiceClient.FindSimilarMatchMode.matchFace);
